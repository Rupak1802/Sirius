  ...
  return (
    <div className="space-y-6 pb-20">
      <div className="flex justify-between items-end mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white tracking-tight">Smart Savings</h1>
      ...
      <div className="glass-card p-8 flex flex-col items-center justify-center text-center relative overflow-hidden">
        ...
        <h3 className="text-xl font-bold text-white mb-2 relative z-10">Emergency Fund</h3>
      ...
      <div className="glass-card p-6 md:p-8 border-emerald-500/30 bg-emerald-900/10">
        <h3 className="text-2xl font-bold text-white mb-2">Save ₹350 this week</h3>
        ...
        <div className="flex gap-4">
          ...
          <button className="px-6 py-3 rounded-xl font-semibold text-slate-300 hover:text-white bg-white/5 hover:bg-white/10 transition-colors border border-white/10">Change</button>
        </div>
      </div>

      <h3 className="text-xl font-bold text-white mt-8 mb-4">Savings Goals</h3>
