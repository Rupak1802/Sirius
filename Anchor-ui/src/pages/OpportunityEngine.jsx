      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <GlassCard className="border-red-500/20 bg-red-900/10 opacity-75">
          <div className="flex justify-between items-start mb-6">
            <h2 className="text-2xl font-bold text-[var(--text-color)]/80">Swiggy</h2>
            <div className="px-3 py-1 bg-white/10 rounded-full text-xs font-medium text-[var(--text-color)]/60">Current</div>
          </div>
          ...
          <div className="flex items-center gap-2 text-[var(--text-color)]/50 bg-black/20 p-3 rounded-lg mt-4">
            <AlertCircle size={16} />
        ...
        <GlassCard className="border-green-500/30 bg-green-900/10 shadow-[0_0_20px_rgba(34,197,94,0.15)] relative overflow-hidden">
          ...
          <div className="flex justify-between items-start mb-6">
            <h2 className="text-2xl font-bold text-[var(--text-color)]">Rapido</h2>
