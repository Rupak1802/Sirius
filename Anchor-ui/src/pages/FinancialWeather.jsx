  ...
  return (
    <div className="space-y-6 pb-20">
      <div className="flex justify-between items-end mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white tracking-tight">Financial Weather</h1>
      ...
      <div className="glass-card p-10 flex flex-col items-center text-center border-blue-500/30 bg-blue-900/10 relative overflow-hidden">
        ...
        <h2 className="text-4xl font-black text-white mb-2 relative z-10">Sunny & Stable</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        <div className="glass-card p-6">
          <h3 className="font-bold text-white mb-4 flex items-center gap-2"><Zap className="text-yellow-400" /> Incoming Energy</h3>
          <div className="space-y-4">
            <div className="flex justify-between items-center bg-white/5 p-4 rounded-xl border border-white/5">
              <span className="text-slate-300">Expected Swiggy</span>
              <span className="font-bold text-white text-lg">₹3,200</span>
            </div>
            <div className="flex justify-between items-center bg-white/5 p-4 rounded-xl border border-white/5">
              <span className="text-slate-300">Expected Zomato</span>
              <span className="font-bold text-white text-lg">₹2,800</span>
            </div>
          </div>
        </div>

        <div className="glass-card p-6">
          <h3 className="font-bold text-white mb-4 flex items-center gap-2"><Navigation className="text-red-400" /> Outgoing Friction</h3>
          <div className="space-y-4">
            <div className="flex justify-between items-center bg-white/5 p-4 rounded-xl border border-white/5">
