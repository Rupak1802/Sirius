  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-4">
        <div>
          <h1 className="text-3xl font-bold text-white tracking-tight">Good evening, Rahul <span className="inline-block animate-waving-hand">👋</span></h1>
      ...
      <div className="glass-card p-6 md:p-8 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-5xl md:text-6xl font-black text-white tracking-tight mb-6 drop-shadow-lg">₹4,280</h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="glass-card p-5">
          ...
          <p className="text-2xl font-bold text-white mb-2">₹5,620</p>
        ...
        <div className="glass-card p-5">
          ...
          <p className="text-2xl font-bold text-white mb-2">₹2,140</p>
          <div className="flex justify-between items-center text-xs">
            <span className="text-slate-500">This week</span>
        ...
        <div className="glass-card p-5">
          ...
          <p className="text-2xl font-bold text-white mb-2">₹2,850</p>
          <div className="flex justify-between items-center text-xs">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="glass-card p-6 border-blue-500/30 bg-blue-900/10 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-xl font-bold text-white">Your week looks stable</h3>
            </div>
          </div>
          ...
          <div className="space-y-4 mb-6 relative z-10">
            <div className="flex justify-between items-center border-b border-white/10 pb-3">
              ...
              <span className="font-semibold text-white">₹5,100–₹5,700</span>
            </div>
            <div className="flex justify-between items-center border-b border-white/10 pb-3">
          ...
          <Link to="/weather" className="block w-full text-center bg-white/10 hover:bg-white/20 border border-white/10 text-white py-3 rounded-xl font-semibold transition-colors">
            See forecast
          </Link>
        </div>
        ...
        <div className="glass-card p-6 border-emerald-500/30 bg-emerald-900/10 relative overflow-hidden">
          ...
          <div className="flex justify-between items-start mb-3 relative z-10">
            <h3 className="text-xl font-bold text-white">Mitra's recommendation</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-3 relative z-10">
            ...
            <button className="px-4 py-3 rounded-xl font-semibold text-slate-400 hover:text-white hover:bg-white/10 border border-transparent hover:border-white/10 transition-colors">
              Not now
            </button>
          </div>
        </div>
      ...
      <div className="glass-card p-6 md:p-8">
        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-white/5 p-4 rounded-2xl border border-white/10 text-center hover:bg-white/10 transition-colors">
            ...
            <p className="font-bold text-white text-lg">₹300</p>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row justify-between items-center gap-6 shadow-[0_0_30px_rgba(147,51,234,0.3)]">
        <div>
          <h3 className="text-2xl font-bold text-white mb-2">What happens if my income drops?</h3>
