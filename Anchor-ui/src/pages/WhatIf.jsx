  ...
  return (
    <div className="space-y-6 pb-20 max-w-4xl mx-auto">
      <div className="flex justify-between items-end mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white tracking-tight">What If Simulator</h1>
      ...
      <div className="glass-card p-6 md:p-10 border-blue-500/20 bg-blue-900/10 shadow-[0_0_30px_rgba(37,99,235,0.1)]">
        ...
        <div className="flex flex-col sm:flex-row gap-6 items-center">
          <div className="flex items-center gap-4 w-full sm:w-auto">
            ...
            />
            <span className="text-4xl font-black text-white w-16 text-center">{days}</span>
      ...
      <div className="glass-card p-8 border-yellow-500/30 bg-yellow-900/10 relative overflow-hidden mt-8 shadow-[0_0_30px_rgba(234,179,8,0.1)]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10 relative z-10">
          <div className="bg-black/40 p-6 rounded-2xl border border-white/5 shadow-inner">
            ...
            <p className="text-4xl font-black text-white">₹{days * 192}</p>
          </div>
          <div className="bg-black/40 p-6 rounded-2xl border border-white/5 shadow-inner">
            <div className="flex items-center gap-2 text-slate-400 mb-2">
            ...
            <p className="text-4xl font-black text-white">{Math.ceil(days * 1.2)} days</p>
          </div>
        </div>

        <div className="flex items-center gap-2 mb-6 relative z-10">
          <Clock className="text-blue-400" size={24} />
          <h3 className="font-bold text-2xl text-white">Recovery Plan</h3>
        </div>
        ...
        <div className="space-y-4 relative z-10">
          <div className="flex items-start gap-4 bg-white/5 p-5 rounded-2xl border border-white/10 backdrop-blur-md">
            ...
            <p className="text-slate-300 text-lg leading-relaxed">Work <span className="font-bold text-white">~7 extra hours</span> over the next week to fully recover.</p>
          </div>
          <div className="flex items-start gap-4 bg-white/5 p-5 rounded-2xl border border-white/10 backdrop-blur-md">
            ...
            <p className="text-slate-300 text-lg leading-relaxed">Switch strictly to your most profitable platform for <span className="font-bold text-white">{days} days</span> after returning.</p>
          </div>
          <div className="flex items-start gap-4 bg-white/5 p-5 rounded-2xl border border-white/10 backdrop-blur-md">
